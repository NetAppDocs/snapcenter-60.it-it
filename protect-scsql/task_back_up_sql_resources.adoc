...
+
È possibile creare un criterio selezionando * *image:../media/add_policy_from_resourcegroup.gif[""]per avviare la procedura guidata.
...
.. Nella finestra di dialogo *Aggiungi pianificazioni per criterio* `policy_name` , configurare la pianificazione, quindi selezionare *OK*.
+
...
.. Selezionare il criterio per cui si desidera configurare la pianificazione della verifica, quindi selezionare * *image:../media/add_policy_from_resourcegroup.gif[""].
