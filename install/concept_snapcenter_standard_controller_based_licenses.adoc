...
** image:../media/controller_not_licensed_icon.gif["Icona di annullamento"] Indica che una licenza della suite SnapManager non è installata su un sistema di storage primario FAS, AFF o ASA.
