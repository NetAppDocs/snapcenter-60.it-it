...
| link:https://docs.netapp.com/us-en/snapcenter-60/protect-azure/protect-applications-azure-netapp-files.html["Supporto per backup Azure NetApp Files"]  a| 
...
| link:https://docs.netapp.com/us-en/snapcenter-60/install/concept_configure_snapcenter_servers_for_high_availabiity_using_f5.html["Supporto per l'alta disponibilità di SnapCenter in esecuzione su Linux"]  a| 
...
| link:https://docs.netapp.com/us-en/snapcenter-60/admin/concept_monitor_jobs_schedules_events_and_logs.html#manage-scheduled-backup-jobs["Possibilità di gestire i processi di backup pianificati"]  a| 
...
| link:https://docs.netapp.com/us-en/snapcenter-60/admin/concept_monitor_jobs_schedules_events_and_logs.html#manage-stale-jobs["Capacità di gestire lavori obsoleti"]  a| 
