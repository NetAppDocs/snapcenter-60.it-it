...
.. Selezionare il criterio per il quale si desidera configurare la pianificazione della verifica, quindi fare clic su *image:../media/add_policy_from_resourcegroup.gif[""].
