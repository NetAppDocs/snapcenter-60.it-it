...
+
È possibile eseguire una ricerca nel gruppo di risorse immettendo il nome del gruppo di risorse nella casella di ricerca oppure facendo clic su * *image:../media/filter_icon.png[""], quindi selezionando il tag. È quindi possibile fare clic su * *image:../media/filter_icon.png[""]per chiudere il riquadro del filtro.
