...
+
Fare clic su image:../media/filter_icon.png["Icona del filtro"] e selezionare il nome host e il server Exchange per filtrare le risorse. È quindi possibile fare clic su image:../media/filter_icon.png["Icona del filtro"] per chiudere il riquadro del filtro.
