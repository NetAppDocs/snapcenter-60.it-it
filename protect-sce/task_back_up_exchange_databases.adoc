...
+
Fare clic su * *image:../media/filter_icon.png[""], quindi selezionare il nome host e il tipo di database per filtrare le risorse. È quindi possibile fare clic su * *image:../media/filter_icon.png[""]per chiudere il riquadro del filtro.
...
+
.. Fare clic su * *image:../media/add_policy_from_resourcegroup.gif[""]nella colonna Configura pianificazioni per il criterio per il quale si desidera configurare una pianificazione.
