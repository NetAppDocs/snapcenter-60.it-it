...
ResourceRequiresAuthentication
 a| 
Sì o No Determina se le risorse, rilevate automaticamente o non rilevate automaticamente, necessitano delle credenziali per eseguire le operazioni di protezione dati dopo il rilevamento dello storage.
